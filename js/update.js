document.addEventListener("DOMContentLoaded", function () {
  ...
  selectTrigger.addEventListener("click", function () {
    ...
    arrow.src = customSelect.classList.contains("open")
      ? "../img/downArrow.svg"
      : "../img/upArrow.svg"; // 화살표를 상태에 따라 변경
  });
  ...
  document.querySelectorAll(".custom-option").forEach((option) => {
    option.addEventListener("click", function () {
      ...
      arrow.src = "../img/upArrow.svg"; // 선택 후 upArrow로 변경
    });
  });
  ...
  document.addEventListener("click", function (e) {
    ...
    if (!select.contains(e.target) && !trigger.contains(e.target)) {
      ...
      arrow.src = "../img/upArrow.svg"; // 클릭 후 upArrow로 변경
    }
  });
  ...
  cardDelete.addEventListener("click", function () {
    window.location.href = "myCard.html?showToast=true";
  });
});
